...
var queryModel = __WEBPACK_IMPORTED_MODULE_0_backbone___default.a.Model.extend({
	urlRoot:'http://ivg-boxx:3000/api/v1/scippy/date=2010-01-02.2010-01-20/modality=CT'
});

/* harmony default export */ __webpack_exports__["a"] = (queryModel);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_dist_css_bootstrap_css__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__App_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_queryModel__ = __webpack_require__(5);
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(function(){
	...
	var queryModel = new __WEBPACK_IMPORTED_MODULE_5__models_queryModel__["a" /* default */]();
	var app = new __WEBPACK_IMPORTED_MODULE_4__App_js__["a" /* default */]({
		el:'body',
		model:queryModel
	});
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_backbone__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_backbone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_backbone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_headerLayout_pug__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_headerLayout_pug___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__templates_headerLayout_pug__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_searchList__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_queryModel__ = __webpack_require__(5);




//import queryCollection from './collections/queryCollection';


var App = __WEBPACK_IMPORTED_MODULE_1_backbone___default.a.View.extend({
	events:{
		'click #submit':'initialQuery'
	},
	initialize(){
		this.render();
		//this.collection = new queryCollection();
	//	this.QueryModel = new QueryModel();
		this.searchList = new __WEBPACK_IMPORTED_MODULE_3__views_searchList__["a" /* default */]({
			el:'.searchList'
		});
	},
	render(){
		this.$el.html(__WEBPACK_IMPORTED_MODULE_2__templates_headerLayout_pug___default()());
	},
	initialQuery: function(){
		...
		/*Backbone.sync("read",this.QueryModel,{
			success:function(){
				console.log("success");
			},
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"col-md-8 Title\"\u003E\u003Ch1 class=\"title col-md-8\"\u003EScippy Web\u003Ch2 class=\"sub\"\u003EABCC VG Group\u003C\u002Fh2\u003E\u003C\u002Fh1\u003E\u003Clabel class=\"Date\"\u003EDate From\u003C\u002Flabel\u003E\u003Cinput id=\"dateFrom\" type=\"date\" name=\"dateFrom\"\u003E\u003Clabel class=\"Date\"\u003EDate To\u003C\u002Flabel\u003E\u003Cinput id=\"dateTo\" type=\"date\" name=\"dateTo\"\u003E\u003Cbutton id=\"submit\" type=\"buttom\"\u003ESearch\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"info col-md-4\"\u003Einfo preserve\u003C\u002Fdiv\u003E\u003Cdiv class=\"searchList\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";;return pug_html;};
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_backbone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_searchListTamplate_pug__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_searchListTamplate_pug___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__templates_searchListTamplate_pug__);



var searchList = __WEBPACK_IMPORTED_MODULE_0_backbone___default.a.View.extend({
	events:{
		'keyup .searchByName': function(){
			this.render();
		},
	},
	initialize(){
		this.$el.html(__WEBPACK_IMPORTED_MODULE_1__templates_searchListTamplate_pug___default()());
	},
	render(){
		$('.showList').html()
	}
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Cinput class=\"searchByName\" type=\"text\" placeholder=\"enter name\"\u003E\u003Cdiv class=\"showList\"\u003E\u003C\u002Fdiv\u003E";;return pug_html;};
module.exports = template;
