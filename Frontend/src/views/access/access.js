...
var access = Backbone.View.extend({
  ...
  changeAccess: function(e){
    ...
    if(!parseInt(this.decision)){
      ...
      let firstName = $(e.currentTarget).attr('firstName');
      let lastName = $(e.currentTarget).attr('lastName');
      let userID = $(e.currentTarget).attr('userID');

      let email = $(e.currentTarget).attr('email');
      let phone_office = $(e.currentTarget).attr('phone_office');
