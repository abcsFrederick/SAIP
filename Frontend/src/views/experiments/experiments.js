...
var experiments = View.extend({
    ...
    edit_experiment: function (e) {
        ...
        let currentEditingExp = this.experimentsAllInfo.find((x) => x.id === this.currentEdit_exp_id);
    ...
    _edit_experiment: function (e) {
        ...
        $.ajax({
            ...
            success: _.bind(function (res) {
                if (!res.err) {
                    let indexToModify = this.experimentsAllInfo.findIndex((x) => x.id === this.currentEdit_exp_id);
